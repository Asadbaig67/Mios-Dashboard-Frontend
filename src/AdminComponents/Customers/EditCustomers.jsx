...
const EditCustomers = () => {
  ...
  const { name, email, role, address, dropShipperStatus, phone, company, city } = user;



  const onChange = (e) => {
    if (e.target.name === "dropShipperStatus") {
      setUser((prevValue) => ({
        ...prevValue,
  ...
  return (
    <div>
      ...
      {loading ? <Loader /> : <>
        ...
        <section className="d-flex align-items-center justify-content-center" style={{ marginTop: '0px' }}>
          <div className="login">
            <form method='post'>
              ...
              <select value={role} style={{ marginTop: '20px', height: "50px", fontSize: '15px', paddingLeft: "2%", paddingRight: "2%" }} className="mb-3" name="role" id='role' placeholder="Password" onChange={onChange} required >
                <option style={{ marginTop: '20px', height: "50px" }} value="" defaultChecked>Role</option>
                <option style={{ marginTop: '20px', height: "50px" }} value="wholeseller">WholeSeller</option>
                <option style={{ marginTop: '20px', height: "50px" }} value="dropshipper">DropShipper</option>
              </select>
              <center>
                {role === "dropshipper" &&
                  <span style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}><input checked={dropShipperStatus} style={{ marginRight: '20px', marginTop: '0px' }} type="checkBox" name="dropShipperStatus" id='dropShipperStatus' placeholder="dropShipperStatus" onChange={onChange} required /><p>  Approved</p></span>}
              </center>
              ...
              <input value={address} type="text" name="address" id='address' placeholder="Address" autoFocus onChange={onChange} required />
              <label className='mt-3'>Company</label>
              <input value={company} type="text" style={{ marginBottom: "20px" }} name="company" id='company' placeholder="Company Name" autoFocus onChange={onChange} />
              <input type="submit" value="Update Details" onClick={EditDetails} />
            </form>
          </div>
        </section>
      </>
