      ...
      {loading ? <Loader /> : <>
        ...
        {show ?
          ...
          < section className="mt-0" style={{ marginTop: '2%' }}>
            {/* Create New WholeSeller Account */}
            <button className='btn btn-info mb-4' onClick={() => setShow(!show)}>{show ? `Add New WholeSeller` : `Show All Wholesellers`}</button>
            <h1>Create New WholeSeller Account</h1>
            <div className="login ">
              <form method='post'>
                <label className='text-start mb-0 mt-3'>name
                </label>
                <input value={name} type="name" name="name" id='name' placeholder="Name" autoFocus onChange={onChange} required />
                <label className='text-start mb-0 mt-3'>email
                </label>
                <input value={email} type="email" name="email" id='email' placeholder="E-mail" autoFocus onChange={onChange} required />
                <label className='text-start mb-0 mt-3'>password
                </label>
