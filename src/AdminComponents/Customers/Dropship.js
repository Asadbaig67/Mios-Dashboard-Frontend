        ...
        {show ?
          <div className='container-fluid'>
            ...
            <div className='row mb-3'>
              <div className='col'>
                <label className='text-start mt-3'>handleChange</label><input type="text" name='search' onChange={handleChange} value={query} className='form-control' placeholder='Search Customer by name' />
              </div>
          ...
          <section className="" style={{ marginTop: '2%' }}>
            ...
            <button className='btn btn-info  mb-4' onClick={() => setShow(!show)}>{show ? `Add New Dropshipper` : `Show All Dropshippers`}</button>
            ...
            <div className="login">
              <form method='post'  >
                ...
                <label className='text-start mt-3'>city</label><select name="city" className='form-select' value={city} onChange={onChange} id="Location" required>
