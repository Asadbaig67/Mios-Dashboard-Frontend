              ...
              <div className="d-flex flex-row mt-2">
                <div className="ms-auto me-5">
                  <div class="form-check">
                    <input class="form-check-input" name="shippingStatus" value={checkFilter.shippingStatus} onChange={setFilters} type="checkbox" id="flexCheckDefault" />
                    <small class="form-check-label" for="flexCheckDefault">
                      Delivered
                    </small>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" name="unshippingStatus" value={checkFilter.unshippingStatus} onChange={setFilters} type="checkbox" id="flexCheckChecked" />
                    <small class="form-check-label" for="flexCheckChecked">
                      Not Delivered
                    </small>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" name="orderStatus" value={checkFilter.orderStatus} onChange={setFilters} type="checkbox" id="flexCheckChecked" />
                    <small class="form-check-label" for="flexCheckChecked">
                      Pending
                    </small>
                  </div>
