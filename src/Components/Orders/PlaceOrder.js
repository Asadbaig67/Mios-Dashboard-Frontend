                                ...
                                <tbody>
                                    {CartItems?.cart.map((i, ind) => {
                                        return (<tr key={ind}>
                                            ...
                                            <td>
                                                {
                                                    ...
                                                    // product name
                                                    i.product.title.length > 40 ? i.product.title.substring(0, 40) + '...' : i.product.title
                                                }
                                            ...
                                            <td>{i.quantity}</td>
                                            <td>Rs.{user.isAdmin === false && user.role === "dropshipper" && user.dropShipperStatus === true ?
                                                <span className="product-price">
                                                ...
                                                {user.isAdmin === false && user.role === 'wholeseller' ?
                                                    <span className="product-price">
                                                        <span>{i.product.onSale && i.product.discountedPriceW ? i.product.discountedPriceW * i.quantity : i.product.wholesalePrice * i.quantity} </span>
                                                    </span> : null}
                                            </td>
                                        </tr>)
                                    })}
