...
const Signup = ({ setuser }) => {
    ...
    useEffect(() => {
        if (userDetails._id && userDetails.isAdmin === false && !(user.role === "dropshipper" && user.dropShipperStatus === false)) {
            setuser(userDetails);
    ...
    const onChange = (e) => {
        if (e.target.name !== 'role') {
            ...
            setUser((prevValue) => ({
                ...prevValue,
                role: e.target.checked ? 'dropshipper' : !e.target.checked ? 'wholeseller' : 'wholeseller'
            }))
        }
    }
            ...
            {loading ? <Loader /> : <section className="area-login">
                <div className="login">
                    ...
                    <form method='post' autoComplete="off"  >
                        ...
                        <input type="name" name="name" id='name' placeholder="Name" autoFocus onChange={onChange} required />
                        ...
                        <div className='' style={{ display: 'flex', flexDirection: "row", alignItems: 'center', justifyContent: "center", height: "50px", margin: '0px' }}>
                            <input style={{ margin: '0' }} type="checkbox" name="role" id='role' autoFocus onChange={onChange} /><p>Apply for Dropsipper</p>
                        </div>
