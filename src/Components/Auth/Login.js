          ...
          <section className="area-login">
            ...
            <div className="login">
              ...
              <form method='post' onSubmit={this.onSubmit} autoComplete="off">
                <input type="email" name="email" id='email' placeholder="E-mail" autoFocus onChange={this.onChange} required autoComplete="off" />
                <input className="mb-3" type="password" name="password" id='password' placeholder="Password" onChange={this.onChange} required autoComplete="off" />
